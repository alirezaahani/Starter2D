 ...
 */
bool Bhv_PenaltyKick::doKickerWait(PlayerAgent *agent)
{
...
bool Bhv_PenaltyKick::doKickerSetup(PlayerAgent *agent)
{
 ...
 */
bool Bhv_PenaltyKick::doKickerReady(PlayerAgent *agent)
{
    const WorldModel &wm = agent->world();
    const PenaltyKickState *state = wm.penaltyKickState();
 ...
 */
bool Bhv_PenaltyKick::doShoot(PlayerAgent *agent)
{
...
bool Bhv_PenaltyKick::doDribble(PlayerAgent *agent)
{
 ...
 */
bool Bhv_PenaltyKick::doGoalieWait(PlayerAgent *agent)
{
 ...
 */
bool Bhv_PenaltyKick::doGoalieSetup(PlayerAgent *agent)
{
    Vector2D move_point(ServerParam::i().ourTeamGoalLineX() + ServerParam::i().penMaxGoalieDistX() - 0.1, 0.0);
 ...
 */
bool Bhv_PenaltyKick::doGoalie(PlayerAgent *agent)
{
    ...
    if (wm.ball().distFromSelf() < SP.catchableArea() - 0.05 && our_penalty.contains(wm.ball().pos()))
    {
 ...
 */
bool Bhv_PenaltyKick::doGoalieBasicMove(PlayerAgent *agent)
{

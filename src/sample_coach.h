...
class SampleCoach : public rcsc::CoachAgent
{
  private:
  ...
  protected:
    ...
    */
    ...
    /*!
      this method is automatically called just after receiving
  ...
  private:
    ...
    void substituteTo(const int unum, const int type);
